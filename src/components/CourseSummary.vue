          ...
          <div class="select-box">
            <div class="column select-box-input">
              ...
              <div class="col-xs-4 col-sm-4 col-md-3 col-lg-3">
                <q-select
                  class="input-box"
                  stack-label="Select teacher's name"
                  color="white"
                  inverted-light
              ...
              <div class="col-xs-2 col-sm-2 col-md-3 col-lg-3">
                <q-btn class="full-width" label="search" color="cyan-6" @click="getReslut" />
              </div>
            </div>
          </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 relative-position" style="background-color: #FDFCFF">
          ...
          <div class="column result-box">
            ...
            <div class="col-xs-4 col-sm-4 col-md-6 col-lg-6"  v-if="showReturnData">
              <p>Please select one of teachers' name</p>
            </div>
            ...
            <pivot
              ...
              hide-settings-text="Hide settings">
...
export default {
  ...
  created () {
    ...
    axios({
      ...
      this.teachers = result.data.data.teachers.map(e => {
        return {
  ...
  methods: {
    ...
    // get () {
    //   this.x = document.getElementsByClassName('hasvalue')
    //   console.log(this.x)
    ...
    getReslut () {
      ...
      setTimeout(() => {
        axios({
          ...
          method: 'post',
          data: {
            query: `query tgQuery ($teacher_id: String!) {
          ...
          this.teachgroup = result.data.data.my_teaching_groups
